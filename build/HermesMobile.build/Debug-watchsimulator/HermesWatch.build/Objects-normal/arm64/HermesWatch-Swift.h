...
#ifndef HERMESWATCH_SWIFT_H
#define HERMESWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HermesWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11HermesWatch13CompanionSync")
@interface CompanionSync : NSObject
...
@class NSString;
@class WCSessionFile;
@interface CompanionSync (SWIFT_EXTENSION(HermesWatch)) <WCSessionDelegate>
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC11HermesWatch18HermesSpeechPlayer")
@interface HermesSpeechPlayer : NSObject <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC11HermesWatch13VoiceRecorder")
@interface VoiceRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface VoiceRecorder (SWIFT_EXTENSION(HermesWatch)) <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC11HermesWatch19WatchRuntimeSession")
@interface WatchRuntimeSession : NSObject <WKExtendedRuntimeSessionDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
